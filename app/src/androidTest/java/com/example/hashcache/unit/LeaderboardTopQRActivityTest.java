...
/**
 * Test class for LeaderboardTopQRActivity. All the UI tests are written here. Robotium test framework is
 used
 */
public class LeaderboardTopQRActivityTest {
    ...
    public void checkNumQRButton(){
        // Asserts that the current activity is the LeaderboardTopQRActivity. Otherwise, show “Wrong Activity"
