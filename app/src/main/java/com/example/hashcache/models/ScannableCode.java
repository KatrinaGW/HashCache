...
public class ScannableCode{
    ...
    /**
     ...
     Creates a ScannableCode object with a code location id, hash info and SHA256 hash.
    ...
    /**
     ...
     Creates a ScannableCode object with an id, code location id, hash info, and comments.
